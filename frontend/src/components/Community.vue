...
<template>
    <div class="min-h-full px-4 pt-24 md:px-16 xl:min-w-full xl:pb-8 xl:pt-24">
        ...
        >
            <figure
                    class="w-80 rounded-xl border-2 shadow-md sm:w-64 xl:w-full cursor-pointer"
            ...
            >
                ...
                <figcaption class="px-4 py-4">
                    <h3
                            ...
                            v-text="recruit.title"
                    />
                    <span
                            class="sm:text:lg relative right-4 block w-24 rounded-tr-lg bg-white text-center font-bold xl:bottom-12 xl:text-xl"
                            v-if="(recruit.coopInfo = 0)"
                    >ONLINE</span>
                    <span
                            ...
                            v-if="(recruit.coopInfo = 1)"
                    >OFFLINE</span>
                    <div class="flex sm:h-16 xl:h-20 flex-col justify-between">
            <span
                    class="block w-fit rounded-md bg-blue-100 px-1 text-sm"
                    v-text="recruit.nickname"
            />
                        <span
                                class="block truncate text-sm"
                                v-text="recruit.projectInfo"
                        />
                        <span
                                class="block w-fit rounded-md bg-red-100 px-1 text-sm"
                                v-text="`~` + `${recruit.regDate}`"
                        />
                    </div>
                </figcaption>
            </figure>
