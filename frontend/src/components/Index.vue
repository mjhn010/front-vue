...
<template>
    ...
    <main>
        ...
        <section class="slider-container">
            ...
            <div class="slider">
                <a href="/your-post-url-10"><img src="/src/assets/images/A3rzk7ZMMuKmrv9y.비비드-rgb.jpg" alt="포트폴리오 섬네일 이미지"></a>
                <a href="/your-post-url-1"><img src="/src/assets/images/92sBdzoNV6uRcMTr.11.gif" alt="포트폴리오 섬네일 이미지"></a>
                <a href="/your-post-url-2"><img src="/src/assets/images/F9C9aBXD9WcJL9eU.태일_기본_백터.png" alt="포트폴리오 섬네일 이미지"></a>
                <a href="/your-post-url-3"><img src="/src/assets/images/BctLFrYLdnFPix7w.커플.jpg" alt="포트폴리오 섬네일 이미지"></a>
                <a href="/your-post-url-4"><img src="/src/assets/images/BctLFrYLdnFPix7w.커플.jpg" alt="포트폴리오 섬네일 이미지"></a>
                <a href="/your-post-url-5"><img src="/src/assets/images/BctLFrYLdnFPix7w.커플.jpg" alt="포트폴리오 섬네일 이미지"></a>
                <a href="/your-post-url-6"><img src="/src/assets/images/BctLFrYLdnFPix7w.커플.jpg" alt="포트폴리오 섬네일 이미지"></a>
                <a href="/your-post-url-7"><img src="/src/assets/images/BctLFrYLdnFPix7w.커플.jpg" alt="포트폴리오 섬네일 이미지"></a>
                <a href="/your-post-url-8"><img src="/src/assets/images/BctLFrYLdnFPix7w.커플.jpg" alt="포트폴리오 섬네일 이미지"></a>
                <a href="/your-post-url-9"><img src="/src/assets/images/BctLFrYLdnFPix7w.커플.jpg" alt="포트폴리오 섬네일 이미지"></a>
            </div>
        ...
        <div class="portfolio-container">
            ...
            <section class="category-section">
                ...
                <div class="sorting-options">
                    ...
                    <button class="sort-button">팔로우 회원만</button>
                </div>
            </section>
            ...
            <section class="list-section">
                ...
                <ul>
                    <li>
                        <div class="thumbnail">
                            <img src="/src/assets/images/BctLFrYLdnFPix7w.커플.jpg" alt="포트폴리오 섬네일 이미지">
                        </div>
                        <div class="information">
                            <div class="portfolio-info-profile">
                                <img src="/src/assets/images/free-icon-user-847969%2028.png" alt="프로필 이미지">
                    ...
                    <li>
                        <div class="thumbnail">
                            <img src="/src/assets/images/V8xLj9bx6VaubDZ3.성찰적 존재(Reflective Being).png" alt="포트폴리오 섬네일 이미지">
                        </div>
                        <div class="information">
                            <div class="portfolio-info-profile">
                                <img src="/src/assets/images/free-icon-user-847969%2028.png" alt="프로필 이미지">
