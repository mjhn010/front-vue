    ...
    <div class="portfolio-container">
      ...
      <section class="category-section">
        ...
        <ul v-if="state.query == null" class="category-list">
          ...
          <li class="category-item javascript" :class="{ active: state.language === 2 }" @click="state.language = 2">
            <button>
          ...
          <li class="category-item visual-basic" :class="{ active: state.language === 6 }" @click="state.language = 6">
            <button>
