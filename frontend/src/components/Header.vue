<template>
    ...
    <header class="com-header">
        <ul class="menu-bar">
            <li><router-link to="/index"><img class="header-logo" src="..assets/images/Pofo.svg" alt="logo"></router-link></li>
            <li class="pro"><a href="">프로젝트</a></li>
            <li class="community"><router-link to="/community">커뮤니티</router-link></li>
        </ul>
        <div class="search-box"><img class="search-img" src="..assets/images/free-icon-search-482631%203.svg" alt="돋보기"><input class="header-search" type="text" placeholder="검색어를 입력해보세요"></div>
        <ul class="m-menu member-bar">
            <li><router-link to="/pofo/reg"><button class="btn btn-3 prj-register">프로젝트 등록</button></router-link></li>
            <li><img class="dm" src="..assets/images/email.png" alt="DM"></li>
            <li><img class="bell" src="..assets/images/bell.png" alt="알림"></li>
            <li><img class="header-profile" src="..assets/images/proflie.svg" alt="마이프로필"></li>
            <li><img class="hamburger-bar" src="..assets/images/menu.png" alt=""></li>
        </ul>
    </header>
</template>
<style>
@import url("/frontend/srcntend/src/assets/css/compoment/header.css");
</style>